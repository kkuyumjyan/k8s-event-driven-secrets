...
import (
	...
	"github.com/kkuyumjyan/k8s-event-driven-secrets/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a06dd29d.edsm.io",
	...
	if err = (&controller.EventDrivenSecretReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "EventDrivenSecret")
		os.Exit(1)
	}
